...
setwd("/home/mirahan/Work/TE-pre/L1HSstats.fewertissues/results.oldLINEcov")
#minuslist <- read.table("duplicate.minus.rsquared", header=FALSE)
#pluslist <- read.table("duplicate.plus.rsquared", header=FALSE)
