...
#####################################################
#results.oldLINE/     results.oldLINEcov/  results.VSTnormal/
resultdir <- "/home/mirahan/Work/TE-pre/L1HSstats.fewertissues/results.VSTnormal"
setwd(resultdir)
save_RECscores(resultdir)
resultdir <- "/home/mirahan/Work/TE-pre/L1HSstats.fewertissues/results.oldLINEcov"
setwd(resultdir)
save_RECscores(resultdir)
resultdir <- "/home/mirahan/Work/TE-pre/L1HSstats.fewertissues/results.oldLINE"
setwd(resultdir)
save_RECscores(resultdir)
